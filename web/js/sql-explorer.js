...
(function (global) {
  ...
  async function runQuery() {
    ...
    try {
      if (typeof global.ensureDataHiveConnectorApi === "function") {
        ...
        if (!apiOk) {
          throw new Error(
            "Connector API is unavailable or outdated. Reload the page, or stop any process on port 5055 and run: python -m api"
          );
        }
      }
  ...
  async function probeSqlApi() {
    try {
      ...
      setStatus("Connector API offline — run: python -m api", true);
    }
  }
