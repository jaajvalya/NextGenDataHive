...
from .config import dotenv_values, load_repo_dotenv
...
def _pg_setting(name: str, default: str) -> str:
    # File values beat os.environ for POSTGRES_*, so editing `.env` takes
    # effect even when the variable was already exported.
    load_repo_dotenv()
    file_vals = dotenv_values("POSTGRES_")
